...
const Add = ({ token }) => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      //send this form data to hit an api
  ...
  return (
    <form
      ...
      className="flex flex-col w-full items-start gap-3 px-12 py-8"
    >
      <div>
      ...
      <button
        type="submit"
        className="w-28 py-3 bg-black text-white mt-4 cursor-pointer "
      >
        ADD
      </button>
    </form>
