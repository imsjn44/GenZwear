...
const Collection = () => {
  ...
  const [sortType, setSortType] = useState("releavant");
    ...
    <div className="flex flex-col sm:flex-row sm:gap-10 pt-10 border-t border-slate-200">
      ...
      <div className="min-w-60">
        ...
        >
          ...
          <div className="flex flex-col text-sm font-light text-gray-700 mt-10 gap-3">
      ...
      <div className="flex-1">
        <div className="flex justify-between text-base sm:text-2xl mb-4 mt-3">
          ...
          <select
            ...
            className="border-2 border-gray-300 text-sm px-2 sm:h-10 sm:mx-18 sm:mr-0"
          >
            <option value="releavant">Sort by: Releavant</option>
